...
export default function CertificateCard({ certificate }: { certificate: Certificate }) {
    return (
        <Link
            ...
            target="_blank"
            className="relative bg-card flex flex-1 flex-col py-6 px-5 group rounded-2xl border border-border transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1"
        >
